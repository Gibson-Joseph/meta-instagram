const PrivacyPolicy: React.FC = () => {
  return (
    <div className='m-6 gap-1'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Yavar Tech Works Pvt Ltd, DVP towers,
            First Floor, Old No.25/1, New No. 4 Kalapatti Main Road, Civil
            Aerodrome Post, Nehru Nagar West.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Z-Agent, accessible from{' '}
            <a
              href='https://copper-ai-agent-dev.yavar.ai'
              rel='external nofollow noopener noreferrer'
              target='_blank'
            >
              https://copper-ai-agent-dev.yavar.ai
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: gibsonjoseph678@gmail.com</li>
      </ul>
    </div>
  );
};
